...
void appDrawScene() {
	...
	glBegin(GL_POLYGON);
		...
		//color blue for letter "S"
		glColor3f(0.1176, 0.4156, 0.7607);
	...
	glBegin(GL_POINTS);
		...
		//color of point, red
		glColor3f(0.7607, 0.1568, 0.1176);
	...
	glBegin(GL_POLYGON);
		//color purple for letter "k"
		glColor3f(0.7607, 0.1098, 0.8784);
		
		// Letter "K" (part 1; left side)
		glVertex2f(-0.35, 0.8);
		glVertex2f(-0.35, 0.2);
		glVertex2f(-0.25, 0.2);
		glVertex2f(-0.25, 0.8);
	...
	glBegin(GL_POLYGON);
		//color yellow for letter "T" 
		glColor3f(0.8509, 0.8823, 0.1372);
